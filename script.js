...
let shuffledQuestions, currentQuestionIndex, startTime;
...
function endQuiz() {
  ...
  {
    question: 'What is the most successful football club in the world?',
    answers: [
  ...
  {
    question: 'Which of the following is the smallest club in english football?',
    answers: [
